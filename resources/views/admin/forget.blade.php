        ...
        <div class="row">
          <div class="col-12">     
            <div class="login-card">
              ...
              Successfully send password on email
               </div>
               @endif
               @if (session('message2'))
               <div class="alert alert-success mb-2" id="hi">
             ...
             Email does not match try again
               ...
               @endif
                <form class="theme-form "  method="post" action="forget_action">
                  
                  @csrf
                     <h4>Setze dein Passwort zurück</h4>
                  ...
                  <div class="form-group mb-0">
                      ...
                      <button class="btn btn-primary btn-block w-100" type="submit">Zurücksetzen                </button>
                    </div>
                  <p class="mt-4 mb-0 text-center">Sie haben bereits ein Passwort?<a class="ms-2" href="{{url('/admin/login')}}">anmelden</a></p>
